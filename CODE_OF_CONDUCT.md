...
This Code of Conduct applies within all community spaces (repository, issues, discussions,
chat), and also applies when an individual is officially representing the community in public
spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainer at **alex@baadev.com**. All complaints will be reviewed and investigated promptly
and fairly. All community leaders are obligated to respect the privacy and security of the
reporter of any incident.

Consequences follow the Contributor Covenant enforcement ladder: correction → warning →
temporary ban → permanent ban, proportionate to the violation.
